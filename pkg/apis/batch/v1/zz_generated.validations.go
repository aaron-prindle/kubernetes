...
func Validate_CronJobSpec(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *batchv1.CronJobSpec) (errs field.ErrorList) {
	...
	// field batchv1.CronJobSpec.TimeZone
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *string, oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update && (obj == oldObj || (obj != nil && oldObj != nil && *obj == *oldObj)) {
			...
			return
		}(fldPath.Child("timeZone"), obj.TimeZone, safe.Field(oldObj, func(oldObj *batchv1.CronJobSpec) *string { return oldObj.TimeZone }), oldObj != nil)...)
