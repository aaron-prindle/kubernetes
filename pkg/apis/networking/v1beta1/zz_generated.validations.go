...
func Validate_IngressClassParametersReference(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *networkingv1beta1.IngressClassParametersReference) (errs field.ErrorList) {
	errs = append(errs, validate.Discriminated(ctx, op, fldPath, obj, oldObj, "namespace", func(obj *networkingv1beta1.IngressClassParametersReference) *string { return obj.Namespace }, func(obj *networkingv1beta1.IngressClassParametersReference) string {
		if obj.Scope == nil {
			var zero string
			return zero
		}
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *string, oldValueCorrelated bool) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("scope"), obj.Scope, safe.Field(oldObj, func(oldObj *networkingv1beta1.IngressClassParametersReference) *string { return oldObj.Scope }), oldObj != nil)...)

	// field networkingv1beta1.IngressClassParametersReference.Namespace
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *string, oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update && (obj == oldObj || (obj != nil && oldObj != nil && *obj == *oldObj)) {
			...
			return
		}(fldPath.Child("namespace"), obj.Namespace, safe.Field(oldObj, func(oldObj *networkingv1beta1.IngressClassParametersReference) *string { return oldObj.Namespace }), oldObj != nil)...)
