...
func Validate_Deployment(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *appsv1.Deployment) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *appsv1.DeploymentSpec, oldValueCorrelated bool) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("spec"), &obj.Spec, safe.Field(oldObj, func(oldObj *appsv1.Deployment) *appsv1.DeploymentSpec { return &oldObj.Spec }), oldObj != nil)...)
...
// to declarative validation rules in the API schema.
func Validate_DeploymentSpec(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *appsv1.DeploymentSpec) (errs field.ErrorList) {
	// field appsv1.DeploymentSpec.Replicas has no validation
	// field appsv1.DeploymentSpec.Selector has no validation
	// field appsv1.DeploymentSpec.Template has no validation

	// field appsv1.DeploymentSpec.Strategy
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *appsv1.DeploymentStrategy, oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update && equality.Semantic.DeepEqual(obj, oldObj) {
				return nil
			}
			...
			return
		}(fldPath.Child("strategy"), &obj.Strategy, safe.Field(oldObj, func(oldObj *appsv1.DeploymentSpec) *appsv1.DeploymentStrategy { return &oldObj.Strategy }), oldObj != nil)...)
...
func Validate_DeploymentStrategy(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *appsv1.DeploymentStrategy) (errs field.ErrorList) {
	...
	// field appsv1.DeploymentStrategy.Type
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *appsv1.DeploymentStrategyType, oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			...
			return
		}(fldPath.Child("type"), &obj.Type, safe.Field(oldObj, func(oldObj *appsv1.DeploymentStrategy) *appsv1.DeploymentStrategyType { return &oldObj.Type }), oldObj != nil)...)

	// field appsv1.DeploymentStrategy.RollingUpdate
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *appsv1.RollingUpdateDeployment, oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update && equality.Semantic.DeepEqual(obj, oldObj) {
				return nil
			}
			...
			return
		}(fldPath.Child("rollingUpdate"), obj.RollingUpdate, safe.Field(oldObj, func(oldObj *appsv1.DeploymentStrategy) *appsv1.RollingUpdateDeployment { return oldObj.RollingUpdate }), oldObj != nil)...)
