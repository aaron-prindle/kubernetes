...
func Validate_U(opCtx operation.Context, obj, oldObj *U, fldPath *field.Path) (errs field.ErrorList) {
	// type U
	errs = append(errs, validate.RequiredIf(opCtx, fldPath, obj, oldObj, "Type == 'M1'", obj.M1)...)
	errs = append(errs, validate.RequiredIf(opCtx, fldPath, obj, oldObj, "Type == 'M2'", obj.M2)...)
