...
func Validate_U(opCtx operation.Context, obj, oldObj *U, fldPath *field.Path) (errs field.ErrorList) {
	// type U
	errs = append(errs, validate.RequiredIf(opCtx, fldPath, obj, oldObj, true, obj.M1)...)
	// errs = append(errs, validate.RequiredIf(opCtx, fldPath, obj, oldObj, obj.M1, obj.Type, "==", "M1")...)
	// errs = append(errs, validate.RequiredIf(opCtx, fldPath, obj, oldObj, obj.M2, obj.Type, "==", "M2")...)
	errs = append(errs, validate.RequiredIf(opCtx, fldPath, obj, oldObj, true, obj.M2)...)

	// field U.TypeMeta has no validation
	// field U.Type has no validation
