...
func Validate_T1(opCtx operation.Context, obj, oldObj *T1, fldPath *field.Path) (errs field.ErrorList) {
	...
	// field T1.Simple
	errs = append(errs,
		func(obj, oldObj *struct{ Field string }, fldPath *field.Path) (errs field.ErrorList) {
			// field     return
		}(&obj.Simple, safe.Field(oldObj, func(oldObj *T1) *struct{ Field string } { return &oldObj.Simple }), fldPath.Child("simple"))...)

	// field T1.Nested
	errs = append(errs,
		func(obj, oldObj *struct {
			OuterField string
			Inner      struct{ InnerField string }
		}, fldPath *field.Path) (errs field.ErrorList) {
			// field     return
		}(&obj.Nested, safe.Field(oldObj, func(oldObj *T1) *struct {
			OuterField string
			Inner      struct{ InnerField string }
		} {
			return &oldObj.Nested
		}), fldPath.Child("nested"))...)
