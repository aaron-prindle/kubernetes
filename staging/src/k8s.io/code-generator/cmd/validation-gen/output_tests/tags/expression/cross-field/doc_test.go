...
// 41315 ns/op (cost disabled, I think?)
...
func Validate_Struct_Native(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *Struct) (errs field.ErrorList) {
	// The expression must be true for the object to be valid.
	// So, we return an error if the expression is false (i.e., if !(minI <= i) which is minI > i).
	if !(obj.MinI <= obj.I) {
		// Use nil for fldPath as the generated code does when the path isn't passed down like this.
		// The actual generated code wraps this logic and sets the path correctly.
