...
func RegisterValidations(scheme *testscheme.Scheme) error {
	...
	scheme.AddValidationFunc((*Root2)(nil), func(ctx context.Context, op operation.Operation, obj, oldObj interface{}, subresources ...string) field.ErrorList {
		if len(subresources) == 0 {
			return Validate_Root2(ctx, op, nil /* fldPath */, obj.(*Root2), safe.Cast[*Root2](oldObj))
		}
		return field.ErrorList{field.InternalError(nil, fmt.Errorf("no validation found for %T, subresources: %v", obj, subresources))}
	})
	scheme.AddValidationFunc((*Root3)(nil), func(ctx context.Context, op operation.Operation, obj, oldObj interface{}, subresources ...string) field.ErrorList {
		if len(subresources) == 0 {
...
var programForStruct2 = validate.Compile("self.minI <= self.i")
...
var programForStruct3 = validate.Compile("self.minI <= self.i")
