...
func Validate_T1(opCtx operation.Context, obj, oldObj *T1, fldPath *field.Path) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(obj, oldObj *v1.ObjectMeta, fldPath *field.Path) (errs field.ErrorList) {
			// field v1.ObjectMeta.Name
			errs = append(errs,
				func(obj, oldObj *string, fldPath *field.Path) (errs field.ErrorList) {
					errs = append(errs, validate.FixedResult(opCtx, fldPath, obj, oldObj, false, "subfield T1.ObjectMeta.Name")...)
					return
				}(&obj.Name, safe.Field(oldObj, func(oldObj *v1.ObjectMeta) *string { return &oldObj.Name }), fldPath.Child("name"))...)

			return
		}(&obj.ObjectMeta, safe.Field(oldObj, func(oldObj *T1) *v1.ObjectMeta { return &oldObj.ObjectMeta }), fldPath.Child("ObjectMeta"))...)
