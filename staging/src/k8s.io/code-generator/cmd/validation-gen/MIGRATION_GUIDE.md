...
This document is a comprehensive guide for migrating existing hand-written validation logic in Kubernetes API types to the new **Declarative Validation** system using `+k8s:` tags.

Migrating hand-written validation is complex because it requires maintaining strict backward compatibility with existing error messages and behaviors. This guide outlines the ideal workflow, common pitfalls, and advanced patterns to reduce friction.

---

## 🚀 The Ideal Migration Flow
...
## ⚠️ Common Pitfalls & Friction Points
