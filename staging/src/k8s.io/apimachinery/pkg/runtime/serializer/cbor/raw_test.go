...
func TestTranscodeRawTypes(t *testing.T) {
	for _, tc := range []struct {
		...
		{
			In:  &metav1.FieldsV1{Raw: string([]byte{0xa0})},
			Out: &metav1.FieldsV1{Raw: `{}`},
		},
		{
			In:  &metav1.FieldsV1{},
			Out: &metav1.FieldsV1{},
		...
		{
			In:  metav1.FieldsV1{Raw: string([]byte{0xa0})},
			Out: metav1.FieldsV1{Raw: string([]byte{0xa0})}, // not addressable
		},
		{
			In:  &[...]metav1.FieldsV1{{Raw: string([]byte{0xa0})}, {Raw: string([]byte{0xf6})}},
			Out: &[...]metav1.FieldsV1{{Raw: `{}`}, {Raw: `null`}},
		},
		{
		...
		{
			In:  &struct{ I fmt.Stringer }{I: &metav1.FieldsV1{Raw: string([]byte{0xa0})}},
			Out: &struct{ I fmt.Stringer }{I: &metav1.FieldsV1{Raw: `{}`}},
		},
		{
			In: &struct {
				E metav1.FieldsV1
				I int64
			}{E: metav1.FieldsV1{Raw: string([]byte{0xa0})}, I: 7},
			Out: &struct {
				E metav1.FieldsV1
				I int64
			}{E: metav1.FieldsV1{Raw: `{}`}, I: 7},
		},
		{
			In: &struct {
				metav1.FieldsV1
			}{FieldsV1: metav1.FieldsV1{Raw: string([]byte{0xa0})}},
			Out: &struct {
				metav1.FieldsV1
			}{FieldsV1: metav1.FieldsV1{Raw: `{}`}},
		},
		{
			In:  &map[string]metav1.FieldsV1{"hello": {Raw: string([]byte{0xa0})}},
			Out: &map[string]metav1.FieldsV1{"hello": {Raw: string([]byte{0xa0})}}, // not addressable
		},
		{
			In:  &map[string][]metav1.FieldsV1{"hello": {{Raw: string([]byte{0xa0})}}},
			Out: &map[string][]metav1.FieldsV1{"hello": {{Raw: `{}`}}},
		},
	} {
