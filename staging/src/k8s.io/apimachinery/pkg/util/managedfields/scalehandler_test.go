			...
			input: []metav1.ManagedFieldsEntry{
				{
					...
					APIVersion: "apps/v1",
					FieldsType: "FieldsV1",
					FieldsV1:   &metav1.FieldsV1{Raw: `{"f:spec":{"f:another-field":{}}}`},
				},
				{
					Manager:    "manager-2",
					Operation:  metav1.ManagedFieldsOperationApply,
					APIVersion: "apps/v1",
					FieldsType: "FieldsV1",
					FieldsV1:   &metav1.FieldsV1{Raw: `{"f:spec":{"f:replicas":{}}}`},
			...
			parent: []metav1.ManagedFieldsEntry{
				{
					...
					APIVersion: "apps/v1",
					FieldsType: "FieldsV1",
					FieldsV1:   &metav1.FieldsV1{Raw: `{"f:spec":{"f:replicas":{},"f:selector":{}}}`},
				},
			},
			subresource: []metav1.ManagedFieldsEntry{
				{
			...
			expected: []metav1.ManagedFieldsEntry{
				{
					...
					APIVersion: "apps/v1",
					FieldsType: "FieldsV1",
					FieldsV1:   &metav1.FieldsV1{Raw: `{"f:spec":{"f:selector":{}}}`},
				},
				{
					Manager:     "scale",
					Operation:   metav1.ManagedFieldsOperationUpdate,
			...
			subresource: []metav1.ManagedFieldsEntry{
				{
					...
					APIVersion:  "autoscaling/v1",
					FieldsType:  "FieldsV1",
					FieldsV1:    &metav1.FieldsV1{Raw: `{"f:status":{"f:replicas":{}}}`},
					Subresource: "scale",
				},
			},
			expected: []metav1.ManagedFieldsEntry{
	...
	}{
		{
			...
			parent: []metav1.ManagedFieldsEntry{
				{
					...
					APIVersion: "apps/v1",
					FieldsType: "FieldsV1",
					FieldsV1:   &metav1.FieldsV1{Raw: `{"f:spec":{"f:the-replicas":{},"f:selector":{}}}`},
				},
				{
					Manager:    "test-other",
					Operation:  metav1.ManagedFieldsOperationApply,
					APIVersion: "apps/v2",
					FieldsType: "FieldsV1",
					FieldsV1:   &metav1.FieldsV1{Raw: `{"f:spec":{"f:not-the-replicas":{},"f:selector":{}}}`},
				},
			},
			subresource: []metav1.ManagedFieldsEntry{
				{
			...
			expected: []metav1.ManagedFieldsEntry{
				...
				},
				{
					...
					APIVersion:  "apps/v1",
					FieldsType:  "FieldsV1",
					FieldsV1:    &metav1.FieldsV1{Raw: `{"f:spec":{"f:the-replicas":{}}}`},
					Subresource: "scale",
				},
			},
		},
		{
			...
			parent: []metav1.ManagedFieldsEntry{
				...
				},
				{
					...
					FieldsType: "FieldsV1",
					FieldsV1:   &metav1.FieldsV1{Raw: `{"f:spec":{"f:test-other":{}}}`},
				},
			},
			subresource: []metav1.ManagedFieldsEntry{
				{
