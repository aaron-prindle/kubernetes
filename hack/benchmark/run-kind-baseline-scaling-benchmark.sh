#!/usr/bin/env bash
# run-kind-baseline-scaling-benchmark.sh
# Scales a baseline Kubernetes cluster across multiple pod counts to prove
# that managedFields is a dominant memory bottleneck at scale.
...
# The specific data points we want to plot to show the O(N) scaling
...
echo "=========================================================="
echo " Starting Baseline Scaling Benchmark (managedFields Bloat)"
...
# Pre-provision enough nodes for the max scale (50,000 pods)
"$(pwd)/hack/benchmark/addnodes.sh" 500
...
echo "=========================================================="
echo " Baseline Scaling Benchmark Complete."