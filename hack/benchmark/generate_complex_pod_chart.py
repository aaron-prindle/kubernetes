...
# Data points from the complex 50k run
master_total = 1945.20
exp_total = 1748.14

create_bar_chart(
    'docs/complex_pod_memory_plot.svg',
    'Total Memory Reduction (50,000 Complex Pods)',
    master_total,
    exp_total,
    'Total API Server Heap (MB)'
)

print("Complex Pod Bar chart SVG generated successfully.")
